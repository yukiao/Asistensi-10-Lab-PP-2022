...
class AnggotaKampus:
    ...
    #Encapsulation
    #Public access
    #dapat kita definisikan dengan secara langsung menuliskan nama dari atribut/ fungsi.
...
class Dosen(AnggotaKampus):
   # "representasi guru"
    ...
    #menerapkan polymorphim dengan mendefinisikan kembali fungsi 
    #tambahan() pada class Dosen
    def tambahan(self):
